(function(){
  ...
  var TRANSLATIONS = {
    en: {
      ...
      case_title: "How the Firmware Studio works — from task to result",
      case_task_t: "Task",
      case_task_d: "Let customers put together a custom Arduino / ESP32 firmware order on their own and see the price right away — without phone calls or long back-and-forth messages.",
      case_solution_t: "Solution",
      case_sol_1: "Configurator: Arduino ⇄ ESP32, controller, displays, LEDs and 4 categories of modules",
      case_sol_2: "Live price in PLN plus the current EUR exchange rate",
      case_sol_3: "Prices come from a Google Sheets price list — change it there, and the site updates",
      case_sol_4: "Orders land in a spreadsheet with an ID and status; the client gets an email in their language at every status change",
      case_result_t: "Result",
      case_result_d: "The customer builds the order and sees the price on their own — in their language, on a phone or a computer. I get a complete, structured order in a spreadsheet and by email, and the customer is kept up to date automatically.",
      case_fact_langs: "site languages",
      case_fact_countries: "countries in the phone picker",
      case_fact_statuses: "order statuses with auto-emails",
      case_fact_bp: "Lighthouse Best Practices",

      guar_title: "Guarantees",
      guar_intro: "What you can count on when we work together.",
      guar_1_t: "Reply within 24 hours",
      guar_1_d: "Every inquiry gets a personal reply — in your language — within a day.",
      guar_2_t: "30 days of free fixes",
    ...
    pl: {
      ...
      case_label: "Studium przypadku",
      case_title: "Jak działa Firmware Studio — od zadania do efektu",
      case_task_t: "Zadanie",
      ...
      case_result_t: "Efekt",
      case_result_d: "Klient sam składa zamówienie i widzi cenę — w swoim języku, na telefonie lub komputerze. Ja dostaję kompletne, uporządkowane zamówienie w arkuszu i na e-mail, a klient jest automatycznie informowany o postępach.",
      case_fact_langs: "języki strony",
      case_fact_countries: "krajów w wyborze numeru",
      case_fact_statuses: "statusów z automatycznym e-mailem",
      case_fact_bp: "Lighthouse: dobre praktyki",

      guar_title: "Gwarancje",
      guar_intro: "Na co możesz liczyć, współpracując ze mną.",
      guar_1_t: "Odpowiedź w ciągu 24 godzin",
      guar_1_d: "Każde zapytanie dostaje osobistą odpowiedź — w Twoim języku — w ciągu doby.",
      guar_2_t: "30 dni bezpłatnych poprawek",
    ...
    de: {
      ...
      case_label: "Fallstudie",
      case_title: "So funktioniert das Firmware Studio — von der Aufgabe zum Ergebnis",
      case_task_t: "Aufgabe",
      case_task_d: "Kunden sollen eine individuelle Arduino-/ESP32-Firmware selbst zusammenstellen und den Preis sofort sehen — ohne Anrufe und langes Hin und Her.",
      ...
      guar_intro: "Worauf Sie sich bei der Zusammenarbeit verlassen können.",
      guar_1_t: "Antwort innerhalb von 24 Stunden",
      guar_1_d: "Jede Anfrage bekommt innerhalb eines Tages eine persönliche Antwort — in Ihrer Sprache.",
      guar_2_t: "30 Tage kostenlose Korrekturen",
    ...
    ru: {
      ...
      case_label: "Кейс",
      case_title: "Как устроен Firmware Studio — от задачи до результата",
      case_task_t: "Задача",
      case_task_d: "Дать клиенту самому собрать заказ на прошивку Arduino / ESP32 и сразу увидеть цену — без звонков и долгой переписки.",
      ...
      case_fact_langs: "языка сайта",
      case_fact_countries: "стран в выборе номера",
      case_fact_statuses: "статусов с автописьмом клиенту",
      case_fact_bp: "Lighthouse: лучшие практики",

      guar_title: "Гарантии",
      guar_intro: "На что вы можете рассчитывать, работая со мной.",
      guar_1_t: "Ответ в течение 24 часов",
      guar_1_d: "На каждую заявку — личный ответ на вашем языке в течение суток.",
      guar_2_t: "30 дней бесплатных правок",
